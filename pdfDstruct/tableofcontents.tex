...
\setmacrotolen\subsectionnumwidth{99.99}

\setmacrotolen\maxpagelen{999}
...
\newskip\sectionskip    \sectionskip=5pt plus 2pt minus 2pt

\def\_section#1{%
    \advancecounter{section}{1}%
    \par\vskip\sectionskip%
...
\def\_subsection#1{%
    ...
    \updatesubsectionnumwidth{\the\pageno}%
    \par%
}
