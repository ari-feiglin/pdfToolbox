...
\macroexp{\addtoccontent {<title>}{<value>}{<depth>}{<anchor>}}
...
\blist
    \item {\tt title}: the style switch for the title (default is \inlinecode|\setfont{rm}|);
    \item {\tt value}: the style switch for the value (default is \inlinecode|\setfont{rm}|);
