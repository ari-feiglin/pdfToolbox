...
\def\drawpath#1#2#3#4#5#6#7#8#9{%
    ...
    \pdfliteral{
        ...
        \csname linecap@#7@wd\endcsname\space 0 m
...
\def\drawbezier#1#2#3#4#5#6#7#8#9{%
    ...
    \pdfliteral{
        ...
        \_multiply{\_subtract{\_regB}{\_regD}}{\_regE} \_multiply{\_subtract{\_regC}{\_regA}}{\_regE}
        \_regA\space\_regB\space cm
        \csname linecap@#8@wd\endcsname\space 0 m
...
\def\diagarrow#1{%
    ...
    \unless\ifx\_dashed\novalue%
        ...
        \else%
            ...
            \gdef\@pathinsert{[\_dA\space\_dB] 0 d}%
        \fi%
    \fi%
    \unless\ifx\_dotted\novalue%
...
%    $\rm in_1$&$\bullet$\cr
%    &&$\rm out_1$&$\bullet$\cr
%    $\rm in_2$&$\bullet$&&&$\rm out_2$\cr
%    $\rm in_3$&&&$\bullet$\cr
%}{%
%    \diagarrow{from={1,1}, to={1,2}, left cap=<}
%    \diagarrow{from={1,2}, to={2,3}}
%    \diagarrow{from={1,2}, to={3,2}}
%    \diagarrow{from={3,1}, to={3,2}}
%    \diagarrow{from={3,2}, to={2,3}}
%    \diagarrow{from={2,3}, to={2,4}}
%    \diagarrow{from={4,1}, to={4,4}, left cap=o, dashed}
%    \diagarrow{from={4,1}, to={4,1}, control=3cm, dashed={1, 3}}
%    \diagarrow{from={2,4}, to={3,5}, text=hello, slide=0, x distance=1cm, y off=1cm, dashed}
%    \diagarrow{from={4,4}, to={3,5}, color=rgb{1 0 .5}, y off=1cm, dotted}
%}
%
...
%
%\def\toothline#1{%
%    \_pdfdraw_lineto{\_multiply{\the\numexpr #1+#1-1\relax}{\toothwidth}}{-\toothheight}
%    \_pdfdraw_lineto{\_multiply{\the\numexpr #1+#1\relax}{\toothwidth}}{\toothheight}
%}
%
%\quitvmode\pdfliteral{%
%    1 j 1 J 1 w
%    0 0 m
%    \_pdfdraw_lineto{\_multiply{0.5}{\toothwidth}}{0}
%    \_prepeat{10}{\toothline}
%    \_pdfdraw_lineto{\_multiply{\_add{\_add{10}{10}}{.5}}{\toothwidth}}{0}
%    \_pdfdraw_lineto{\_multiply{\_add{\_add{10}{10}}{1}}{\toothwidth}}{0}
%    S
%}
%
%\bye
