...
\def\drawpath#1#2#3#4#5#6{%
    ...
    \_gettransformedcoords\_regG\_regH{0}{0}%
    \_gettransformedcoords\_regI\_regJ{\csname linecap@#5@wd\endcsname}{0}%
    \_gettransformedcoords\_regJ\_regK{\csname linecap@#6@wd\endcsname}{0}%
    \edef\_regH{\_nopt{\_regJ pt-\_regG pt}}%
    \edef\_regG{\_nopt{\_regI pt-\_regG pt}}%
    \pdfliteral{%
    ...
    \_pdfdraw_setaffinetransform%
        ...
        {\_regA}{\_regB}%
    \pdfliteral{\csname linecap@#5\endcsname}
    ...
    \pdfliteral{
        ...
        \csname linecap@#5@wd\endcsname\space 0 m
        \_nopt{\_regF pt - \csname linecap@#6@wd\endcsname pt} 0 l
        S
        Q
    }%
    \_pdfdraw_setaffinetransform%
        ...
        {\_multiply{\_subtract{\_regB}{\_regD}}{\_regE}}{\_multiply{\_subtract{\_regC}{\_regA}}{\_regE}}%
        {\_regC}{\_regD}%
    \pdfliteral{\csname linecap@#6\endcsname}
    \_pdfdraw_popaffinetransform%
}
...
\definelinecap{>}{%
    \_pdfdraw_moveto{-2}{0} \_pdfdraw_lineto{0}{0} \_pdfdraw_lineto{-2}{1} \_pdfdraw_moveto{0}{0} \_pdfdraw_lineto{-2}{-1}
    S
}{2}
...
\def\diagarrow#1{%
    ...
    \_diagarrow{\_fromx}{\_fromy}{\_tox}{\_toy}{\_lcap}{\_rcap}%
}
...
\say{Transform origin: \_pdfdraw_transform{0}{0}}%
\drawdiagram{%
    ...
    \diagarrow{from={1,1}, to={1,2}, right cap=>>, left cap=<<}%
