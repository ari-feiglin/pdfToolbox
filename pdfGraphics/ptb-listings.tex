...
\gdef\_listfile#1[#2-#3]{%
    \bgroup%
    \lstheader={\hbox to\hsize{\hfil\lstfileheaderfontset#1}}%
    \lstfooter={}%
    \the\everylisting%
    \setupverb%
    ...
    \loop%
        ...
        \else\let\_stop=\_nul\fi\fi%
        \ifeof\_PTBread\let\_stop=\_nul\fi%
...
\def\syntaxoutboxsetbuf{{%
    \setbox0=\hbox{\the\lstheader}%
    \setbox1=\hbox{\the\lstfooter}%
