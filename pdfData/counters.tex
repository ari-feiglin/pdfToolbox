...
\def\advancecounter#1#2{%
    \advance\csname count@#1\endcsname by #2\relax%
    \zerodependents{#1}%
}

\def\advanceicounter#1#2{%
    \advance\count\csname count@#1\endcsname by #2\relax%
}

\def\seticounter#1#2{%
    \count\csname count@#1\endcsname=#2\relax%
}
